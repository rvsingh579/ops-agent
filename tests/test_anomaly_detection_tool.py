...
# --- detect_anomalies: real cached data, no LLM involved. unit/cycles are
# now separate typed arguments, same as data_retrieval_tool. ---
...
def test_detect_anomalies_flags_more_near_failure_than_early_life():
    ...
    early = detect_anomalies(1, "1-20")
    late = detect_anomalies(1, "last 20")
...
def test_detect_anomalies_returns_error_for_nonexistent_cycle():
    result = detect_anomalies(1, "9999")
